      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 gradient-green text-primary-foreground font-body font-semibold px-4 py-2 md:px-6 md:py-3 rounded-full hover:opacity-90 transition-all hover:scale-105 active:scale-95 text-sm md:text-base shadow-lg shadow-primary/20"
          >
            <svg
